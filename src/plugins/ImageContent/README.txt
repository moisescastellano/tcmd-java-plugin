...
======================
This plugin shows image file informations as additional columns in the Total Commander window.
Supported file extensions are BMP, ICO, JPG, JPEG, GIF, PNG
The additional columns shows: the picture type, the color depth, top left X/Y value, the picture width and height,
the transparent pixel, the transparent type (pixel, mask, alpha, none)

How to use this plugin:
=======================
Right click on the column header of the Total Commander main window and choose "configure custom columns".
Click Button New, type in a new name "picture details" and choose "add columns".
Press "+"-sign and choose "imagecontent" then choose the information you want to see.
Press button OK twice to return to the Total Commander main window.

Plugin Directory Contents:
==========================
demo1.jpg - example image file
demo2.jpg - example image file
ImageContent.wdx - The plugin file you installed

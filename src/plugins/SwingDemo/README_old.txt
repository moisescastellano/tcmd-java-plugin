...
======================
This plugin shows a Demo graphical user interface based on Swing, contained in every Java Installation (http://java.sun.com).
It is used to demonstrate the possibilities you have for your own custom Java Plugin.
This implementation is based on the SwingSet2 Demo (http://java.sun.com/products/javawebstart/demos.html)

How to use this plugin:
=======================
Simply open the file "demo.swing" in the lister window (F3) or in quick view (Ctrl+Q) to show up the demo.
You can interact with the GUI elements to test the functionality and to learn about Swing components.
...
==========================
demo.swing - example file to show the demo
SwingDemo.wlx - The plugin file you installed

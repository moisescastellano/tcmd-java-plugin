...
======================
This plugin shows the integration of windows applications (Acrobat Reader, Word, Excel, Powerpoint).
DOC, RTF, TXT - Microsoft Word
XLS - Microsoft Excel
WMV, MPA, MPG, MPEG, AVI, ASF, WAV - Windows Media Player
PDF - Adobe Acrobat Reader

How to use this plugin:
=======================
Simply open the file "demo.pdf" in the lister window (F3) or in quick view (Ctrl+Q) to show up the demo.
